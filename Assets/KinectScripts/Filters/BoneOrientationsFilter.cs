...
public class BoneOrientationsFilter
{
    ...
    public void Reset()
    {
        this.history = new FilterDoubleExponentialData[(int)KinectCommon.NuiSkeletonPositionIndex.Count];
    }

    // Implements a double exponential smoothing filter on the skeleton bone orientation quaternions.
    public void UpdateFilter(ref KinectCommon.NuiSkeletonData skeleton, ref Matrix4x4[] jointOrientations)
    {
//        if (null == skeleton)
//        {
//            return;
...
//        }
        ...
        {
			//KinectCommon.NuiSkeletonPositionIndex jt = (KinectCommon.NuiSkeletonPositionIndex)jointIndex;
            ...
            if (skeleton.SkeletonTrackingState[jointIndex] != KinectCommon.NuiSkeletonPositionTrackingState.Tracked || 
				jointIndex == (int)KinectCommon.NuiSkeletonPositionIndex.FootLeft || jointIndex == (int)KinectCommon.NuiSkeletonPositionIndex.FootRight)
            {
