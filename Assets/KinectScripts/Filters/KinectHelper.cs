...
public class KinectHelper 
{
    ...
    public static bool IsTracked(KinectCommon.NuiSkeletonData skeleton, int jointIndex)
    {
//            if (null == skeleton)
//            {
//                return false;
//            }
		...
		return skeleton.SkeletonTrackingState[jointIndex] == KinectCommon.NuiSkeletonPositionTrackingState.Tracked;
    }
